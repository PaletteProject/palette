...
export function transferOfflineToTokenGrading(
    ...
    if (!savedOfflineGrades) {
      alert("⚠️ No offline grades found for this course and assignment.");
      return;
    }
  
    const parsedOfflineGrades: PaletteGradedSubmission[] = JSON.parse(savedOfflineGrades);
    ...
    setGradedSubmissionCache((prev) => {
      ...
      console.log("✅ Transferred offline grades to token-based grading:", updatedCache);
      return updatedCache;
    });
  
    alert("✅ Offline grades have been successfully transferred to Token-Based Grading!");
  }
